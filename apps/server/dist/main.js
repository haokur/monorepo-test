...
var utils_1 = require("@mono/utils");
...
app.use((0, koa_static_1.default)(path_1.default.resolve(__dirname, '../assets')));
router.get('/', function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        result = (0, utils_1.count)(4, 5);
        ctx.body = 'hello main' + 'count result is ' + result;
        return [2 /*return*/];
    });
}); });
router.get('/video', function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
